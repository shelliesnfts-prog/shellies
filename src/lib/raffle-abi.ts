...
export const raffle_abi = [
  ...
  },
  {
    ...
    "inputs": [
      { "indexed": true,  "internalType": "uint256", "name": "raffleId",       "type": "uint256" },
      { "indexed": true,  "internalType": "address", "name": "prizeToken",     "type": "address" },
      { "indexed": false, "internalType": "uint256", "name": "prizeTokenId",   "type": "uint256" },
      { "indexed": false, "internalType": "bool",    "name": "isNFT",          "type": "bool"    },
      { "indexed": false, "internalType": "uint256", "name": "pointsPerTicket","type": "uint256" }
    ],
    "name": "RaffleCreated",
    "type": "event"
  },
  ...
  },
  {
    ...
    "inputs": [
      { "indexed": true,  "internalType": "uint256",                              "name": "raffleId", "type": "uint256" },
      { "indexed": false, "internalType": "enum ShelliesRaffleContract.RaffleState","name": "oldState","type": "uint8"   },
      { "indexed": false, "internalType": "enum ShelliesRaffleContract.RaffleState","name": "newState","type": "uint8"   }
    ],
  ...
  },
  {
    ...
    "name": "ShelliesPointsContractUpdated",
    "type": "event"
  },
  {
    "anonymous": false,
  ...
  },
  {
    ...
    "outputs": [
      { "internalType": "bool",    "name": "hasAdmins",      "type": "bool"    },
      { "internalType": "uint256", "name": "adminCount",     "type": "uint256" },
      { "internalType": "bool",    "name": "isCallerAdmin",  "type": "bool"    },
      { "internalType": "address", "name": "pointsContract", "type": "address" }
    ],
    "stateMutability": "view",
    "type": "function"
  },
  ...
  },
  {
    ...
    "outputs": [
      ...
      { "internalType": "enum ShelliesRaffleContract.RaffleState",         "name": "state",          "type": "uint8"   },
      { "internalType": "bool",                                            "name": "isNFT",          "type": "bool"    },
      { "internalType": "address",                                         "name": "winner",         "type": "address" },
      { "internalType": "uint256",                                         "name": "pointsPerTicket","type": "uint256" }
    ],
    "stateMutability": "view",
    "type": "function"
  },
  {
    "inputs": [{ "internalType": "uint256", "name": "raffleId", "type": "uint256" }],
    "name": "getRaffleState",
    "outputs": [{ "internalType": "enum ShelliesRaffleContract.RaffleState", "name": "", "type": "uint8" }],
    "stateMutability": "view",
    "type": "function"
  },
  {
  ...
  },
  {
    ...
    "outputs": [
      { "internalType": "address",                                       "name": "prizeToken",     "type": "address" },
      { "internalType": "uint96",                                        "name": "prizeTokenId",   "type": "uint96"  },
      { "internalType": "uint96",                                        "name": "pointsPerTicket","type": "uint96"  },
      { "internalType": "enum ShelliesRaffleContract.RaffleState",       "name": "state",          "type": "uint8"   },
      { "internalType": "bool",                                          "name": "isNFT",          "type": "bool"    },
      { "internalType": "address",                                       "name": "winner",         "type": "address" }
    ],
  ...
  },
  {
    "inputs": [
      ...
      { "internalType": "uint256", "name": "_pointsPerTicket", "type": "uint256" }
    ],
  ...
  },
  {
    "inputs": [
      ...
      { "internalType": "uint256[]", "name": "ticketCounts","type": "uint256[]" },
  ...
  },
  {
    ...
    "name": "setShelliesPointsContract",
    "outputs": [],
    "stateMutability": "nonpayable",
    "type": "function"
  },
