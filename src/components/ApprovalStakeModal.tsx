...
export default function ApprovalStakeModal({
  ...
  const handleApproval = async () => {
    try {
      ...
      // Wait a bit for transaction to be mined before proceeding
          ...
          <div className={`p-4 rounded-xl ${
            ...
            <div className={`text-sm space-y-1 ${
              ...
              <div className="flex items-center space-x-2">
                ...
                <span>Earn 10 points per day for each staked NFT</span>
              </div>
              <div className="flex items-center space-x-2">
                <Trophy className="w-4 h-4" />
                <span>Keep your NFTs secure in the staking contract</span>
              </div>
            </div>
          </div>
